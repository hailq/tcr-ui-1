...
import { challengeResolved, checkSubjectStatus } from '../web3/web3';
...
class Listing extends Component {
  ...
  initState = () => {
    ...
    if (listing) {
      ...
      ["Algebra", "Chemistry"].forEach((subject) => {
        checkSubjectStatus(listing.listingHash, subject, (result) => {
          console.log(result);
          if (result === true) {
      ...
      return (
        <div>
          ...
          <ListGroup>
            ...
            <ListGroupItem><b>Subjects:</b> {subjects.join(", ")}</ListGroupItem>
          </ListGroup>
